...
Ayrıca 2024 Ağustos’unda **Artikel 5 e.V.** gibi tanınmış Alman relay operatörlerine polis baskını yapıldı. Silahlı polis ev ve ofise girdi, faturalar ve log’lar alındı.
...
Ben Qubes'i 1 ay gibi bir süre kullanmaya çalıştım ancak o kadar yıprattı ki beni, kullanıcı sayısı az, teknik destek bulacağın yer az, çok fazla hata alıyorsun, bir dosyayı başka bir vm'e yüklemek bile bir prosedür istiyor. İnterneti ayarlayıp youtubeye girmek için bile çok uğraştım.\
Eğer tehdidiniz büyük değilse, tails kullanımı daha faziletli olacaktır sizin için, youtubeye daha kolay erişirsiniz en azından.
