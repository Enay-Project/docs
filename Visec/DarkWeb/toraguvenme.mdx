...
### Almanların Yöntemi: “Bilinen Sinyal \+ Relay İzleme \+ ISP Logları” Kombinasyonu
...
Ben Qubes'i 1 ay gibi bir süre kullanmaya çalıştım, kullanıcı sayısı az, teknik destek bulacağın yer az,b ir dosyayı başka bir vm'e yüklemek bile bir prosedür istiyor. İnterneti ayarlayıp youtubeye girmek için bile çok uğraştım. Uzman işi denilebilir. Eğer tehdidiniz büyük değilse, tails kullanımı daha faziletli olacaktır sizin için, youtubeye daha kolay erişirsiniz en azından.
...
Sistem ne kadar üzerinize gelirse gelsin, her zaman bir çıkış yolu vardır. Sistem sizi takip etmek isteyebilir, alışkanlıklarınızı, sevdiklerinizi, almak istediğiniz ürünleri alıp reklam şirketlerine pazarlamak isteyebilir. İnternete para ödüyorsun, istediğin gibi kullanmak, engellere takılmamak senin en büyük hakkın. Girdiğin sosyal medya hesabına kimlik bilgilerini girmek, KYC gibi bir saçmalığın varlığı... İnternetin ilk çıkış felsefesi olan "özgür ve anonim bilgi paylaşımı" yerini her adımın izlendiği bir yapıya bıraktı. Sistem seni bir balona koydu ve bir ucuna vakum koyup çekiyor. Balon havasını kaybettikçe plastik daralıp derini kaplıyor, sistem seni daha belirgin görmek istiyor. Daralmıyor musun gerçekten?