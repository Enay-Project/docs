...
<Warning>
  Bu çalışma, proc ortamında sömürülebilir bir güvenlik açığı teşhisinden ziyade, yerel bir ortamda bellek manipülasyonu ve hata ayıklayıcı araçlarıyla sistem mantığının nasıl bypass edilebileceğini gösteren bir kavram kanıtıdır. Yerel erişim ve hata ayıklama yetkisi olan bir ortamda, dünyanın en güvenli kriptografik kütüphaneleri bile aynı yöntemle "yıkılabilir". Buradaki asıl maksat, uygulama kodundaki iç doğrulama katmanlarının teorik eksikliğine dikkat çekmektir.
</Warning>